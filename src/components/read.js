  ...
  return (
    <>
      {employees.map((employee) => (
        <div key={employee.id} className="square border border-dark w-50 p-2 mb-3 offset-3">
          <ListGroup>
          ...
          <Button className="square border border-danger" variant="danger" onClick={() => handleRemove(employee.id)}>
            Remove
          </Button>
